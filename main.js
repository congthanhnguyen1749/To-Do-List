...
function call() {
	...
	eleTodoListt.innerHTML +=
		'<div class="box__Task-todo-list-son-2-con-info"><input type="text" name="" value="" placeholder="Chage title..."><div class="dis"><p class="no" >Description</p><textarea  class="no-1" name="" id="" cols="52" rows="4"></textarea></div><div class="box-time"><div class="box__Task-1"><strong>Due Date</strong><input value="2022-01-14" type="date" name="bday"></div><div class="box__Task-2"><strong>Piority</strong><select name="skill" id="skills-2"><option value="0">Normal</option><option value="1">High</option><option value="2">Low</option></select></div></div><a href="#" class="link" onclick="editTask(id)" ><div class="update"  ><p>Update</p></div></a></div>';
}
